...
const Benchmarks = ({ connection }) => {
    if (!connection.startsWith('mock://')) {
        return (
    ...
    return (
        <div className="flex-1 flex flex-col bg-white h-screen font-sans overflow-y-auto">
            {/* Header Path */}
            <div className="px-6 py-3 border-b border-gray-200 flex items-center text-sm text-green-700 bg-white">
                <span className="font-medium hover:underline cursor-pointer">System</span>
            ...
            <div className="p-8 max-w-6xl mx-auto w-full">
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-800 mb-2">Vector Search Comparison</h1>
